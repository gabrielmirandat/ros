...
if("TRUE" STREQUAL "TRUE")
  set(fcr2017_SOURCE_PREFIX /home/gabriel/ros/projects_ws/src/fcr/#resources/tr_final_zrobot/FCR_FINAL)
  set(fcr2017_DEVEL_PREFIX /home/gabriel/ros/projects_ws/devel)
  set(fcr2017_INSTALL_PREFIX "")
  set(fcr2017_PREFIX ${fcr2017_DEVEL_PREFIX})
else()
  set(fcr2017_SOURCE_PREFIX "")
  set(fcr2017_DEVEL_PREFIX "")
  set(fcr2017_INSTALL_PREFIX /home/gabriel/ros/projects_ws/install)
...
if(NOT "/home/gabriel/ros/projects_ws/src/fcr/#resources/tr_final_zrobot/FCR_FINAL/include " STREQUAL " ")
  set(fcr2017_INCLUDE_DIRS "")
  set(_include_dirs "/home/gabriel/ros/projects_ws/src/fcr/#resources/tr_final_zrobot/FCR_FINAL/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'fcr2017' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Gabriel Miranda <gabrielmirandatt@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'fcr2017' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gabriel/ros/projects_ws/src/fcr/#resources/tr_final_zrobot/FCR_FINAL/${idir}'.  Ask the maintainer 'Gabriel Miranda <gabrielmirandatt@gmail.com>' to fix it.")
    endif()
